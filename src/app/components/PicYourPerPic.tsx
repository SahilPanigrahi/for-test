      ...
      <div>
        ...
        <div className="mt-10 mb-[51px]">
          ...
          <div className="flex justify-center mt-5">
            <p
              className={`cursor-pointer px-4 py-2 rounded-tl-[7px] rounded-bl-[7px] ${
                isToggle
                  ? "text-black border border-[#1644E9] bg-gradient-to-r from-[#1644E933] to-[#D92EF533]"
                  : "border border-[#DDDCDC]"
              }`}
            ...
            <p
              className={`cursor-pointer px-[19px] py-2 rounded-tr-[7px] rounded-br-[7px] ${
                !isToggle
                  ? "text-black border border-[#1644E9] bg-gradient-to-r from-[#1644E933] to-[#D92EF533]"
                  : "border border-[#DDDCDC]"
              }`}
        ...
        <div className="xl:px-[100px] sm:mx-44 lg:mx-72 xl:mx-0 p-2 flex flex-col pb-10 lg:flex-row justify-center gap-6">
          <div className="flex flex-col w-[397px] h-[919px] z-10 bg-white rounded-t-[6px] mt-[16px]">
            ...
            <div className="rounded-b-[6px] bg-white">
              <div className="flex flex-col gap-3 w-[328px] h-[74px] mx-[48px] mt-[35px]">
                <p className="text-[20px] text-center">Buisness Plan</p>
            ...
            {/* <div className="mt-8">
              ...
              <div className="flex gap-1 mt-5 mb-5 ml-[48px]">
                <Image
                  ...
                  className="mr-2"
                />
                <p className="underline gradient-text gradient-underline">
                  and more
                </p>
              </div>
            </div> */}
          ...
          <div className="w-[397px] h-[949px] z-10 gradient-curve-border ">
            <div className="content flex flex-col">
              <p className="px-[130px] text-white bg-gradient-to-r from-[#1644E9] to-[#D92EF5] py-3 z-30 text-center">
                POPULAR
              </p>

              <p className="text-[13px] text-[#1745E9] bg-[#E7F1FE] px-10 py-3 rounded-[100px] text-center mx-auto mt-[35px] mb-[15px] font-medium">FREE TRIAL</p>

              <div className="rounded-b-[6px] bg-white">
                <div className="flex flex-col gap-3 w-[328px] h-[74px] mx-[32px]">
                  <p className="text-[20px] text-center">Free Plan</p>
                  <div className="flex justify-center items-center">
          ...
          <div className="flex flex-col w-[397px] h-[919px] z-10 bg-white rounded-t-[6px] mt-[16px]">
            ...
            <div className="rounded-b-[6px] bg-white">
              <div className="flex flex-col gap-3 w-[328px] h-[74px] mx-[48px] mt-[35px]">
                <p className="text-[20px] text-center">Individual Plan</p>
                <div className="flex justify-center items-center">
